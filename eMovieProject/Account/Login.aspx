<%@ Page Title="Iniciar Sesión" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="Login.aspx.cs" Inherits="eMovieProject.Account.Login" %>
        ...
        <LayoutTemplate>
            ...
            <div class="accountInfo">
                ...
                <p class="submitButton">
                    <asp:Button ID="LoginButton" runat="server" OnClick="OnClickLogin" Text="Iniciar sesión" ValidationGroup="LoginUserValidationGroup"/>
                </p>
            </div>
        </LayoutTemplate>
    </asp:Login>
